...
path = pcb.new(0, 0, W_50, (1, 0), pcb.z(1))[1]
...
path = pcb.new(anchor.x, anchor.y, anchor.width, anchor.direction, pcb.z(1))
...
output_stub = pcb.new(anchor.x, anchor.y, anchor.width, anchor.direction, pcb.z(1))
...
# The tightest coupling gap (S1 = 0.1 mm) needs a fine mesh there
