...
pcb = em.geo.PCB(th, unit=mm, material=em.lib.DIEL_RO4003C, trace_material=em.lib.PEC)
...
path = pcb.new(0, 0, W_feed_in, (1, 0), 1)[1].straight(Lfeed, W_feed_in)
...
# Modal ports
# ---------------------------------------------------------------------------
p1 = pcb.modal_port(1, 1, height=Hair, width=15) # Input
p2 = pcb.modal_port(2, 2, height=Hair, width=15) # Output
