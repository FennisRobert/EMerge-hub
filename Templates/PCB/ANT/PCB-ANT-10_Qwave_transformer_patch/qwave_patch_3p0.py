# =============================================================================
# EMerge Simulation Template: PCB-ANT-10
#
...
pcb.new(-feed_length-l_transformer, 0, w0, (1,0), 1)['port'].straight(feed_length).straight(l_transformer, width=w1).straight(Lpatch, Wpatch)
