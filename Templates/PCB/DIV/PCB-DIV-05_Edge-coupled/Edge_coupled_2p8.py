...
pcb = em.geo.PCBNew(th, 1.0, material=em.lib.DIEL_FR4, trace_material=em.lib.PEC, trace_thickness=thcu, thick_traces=True)

pcb.new(0, y0, w0, (0,-1), pcb.z(1))[1].straight(Lf)\
    .move(dx=w0/2, dy=-w1/2, direction=(1,0), width=w1).straight(Lq)\
    .move(dx=w0/2, dy=w1/2, direction=(0,1), width=w0).straight(Lf, w0)[3]
pcb.new(0, -y0, w0, (0,1), pcb.z(1))[2].straight(Lf)\
    .move(dx=w0/2, dy=w1/2, direction=(1,0), width=w1).straight(Lq)\
